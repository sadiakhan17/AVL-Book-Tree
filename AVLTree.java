      ...
      switch (balanceFactor(A)) {
        case -2:
          if (balanceFactor((AVLTreeNode<E>)A.left) <= 0) {
			...
			System.out.println("Imbalance condition occurred at inserting " + o + "; fixed in LeftLeft Rotation");
          }
          else {
			balanceLR(A, parentOfA); // Perform LR rotation
			System.out.println("Imbalance condition occurred at inserting " + o + "; fixed in LeftRight Rotation");
          }
          break;
        case +2:
          if (balanceFactor((AVLTreeNode<E>)A.right) >= 0) {
            balanceRR(A, parentOfA); // Perform RR rotation
			System.out.println("Imbalance condition occurred at inserting " + o + "; fixed in RightRight Rotation");
          }
          else {
            balanceRL(A, parentOfA); // Perform RL rotation
			System.out.println("Imbalance condition occurred at inserting " + o + "; fixed in RightLeft Rotation");
          }
      }
    }
  }
